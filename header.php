...
<tbody><tr>
<td rowspan="2" height="113"><img src="files/logoo.gif" border="0" height="113" width="211"></a></td>
...
<tr>
<td background="files/mnubg.gif" height="27" valign="middle" width="100%" align="right">

<table align="right">
<tr>
	<td valign="middle"><img src="files/date.png" /></td><td class="td1"><?php echo date('l dS \of F Y'); ?>&nbsp;|&nbsp;</td><td><img src="files/053.png" height="18" width="18" /></td><td class="td1"><span id="basicclock"><script language="JavaScript" type="text/javascript">clock();</script></span></td>
</tr>
</table>
